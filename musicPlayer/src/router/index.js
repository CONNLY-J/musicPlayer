...
const friendIndex = () => import(/* webpackChunkName: "group-homePage" */ '@/pages/friendIndex/index')
const friends = () => import('@/pages/friendIndex/components/friends')
const message = () => import('@/pages/friendIndex/components/message')
const sendMsg = () => import('@/pages/friendIndex/components/sendMsg')

const addFriends = () => import ('@/pages/friendIndex/components/addFriends')
...
// const share = () => import('@/pages/share/index')
// const friend = () => import('@/pages/friends/friends')
