...
export const getNewSongsInfo = api + '/song'
...
// =================朋友页面
export const userFollows = api + '/user/follows' // 获取朋友页面的动态
export const follow = api + '/follow'
export const msgPrivate = api + '/msg/private'   //获取私信
export const pushMsg = api + '/send/text'  //发送私信
export const addOrDeleteFriendsList = api + '/follow'
// =================歌单事件
