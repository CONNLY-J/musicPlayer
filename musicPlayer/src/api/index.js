...
export default {
  ...
  getNewSongsInfoFn (id) {
    return axios.get(getNewSongsInfo, {
      params: {
        id
      }
    })
   ...
   */
  userFollowsFn (uid,limit=10,offset) {
  ...
  msgPrivateFn(){
    return axios.get(msgPrivate,{
      params:{

      }
    })
  },
  pushMsgFn(user_ids,msg){
    return axios.get(pushMsg,{
      params:{
        user_ids,
        msg
      }
  ...
  addOrDeleteFriendsListFn(id,t){
    return axios.get(addOrDeleteFriendsList,{
      params:{
        id,
        t
      }
